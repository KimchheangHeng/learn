...
SWIFT_MODULE_NAMESPACE_PUSH("Vision_ML_Example")
@class UIWindow;

SWIFT_CLASS("_TtC17Vision_ML_Example11AppDelegate")
...
@interface ImageClassificationViewController (SWIFT_EXTENSION(Vision_ML_Example)) <UIImagePickerControllerDelegate, UINavigationControllerDelegate>
