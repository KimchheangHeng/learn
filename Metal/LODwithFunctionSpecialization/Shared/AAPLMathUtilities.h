...
// Creates a vector_float3
vector_float3 AAPL_SIMD_OVERLOAD vector_make(float x, float y, float z);

// Creates a vector_float4
vector_float4 AAPL_SIMD_OVERLOAD vector_make(float x, float y, float z, float w);
...
matrix_float4x4 AAPL_SIMD_OVERLOAD matrix_look_at(float eyeX, float eyeY, float eyeZ,
